...
watch(
    () => props.messageId,
    (newValue) => {
        if (newValue) newMessageId.value = newValue;
    },
    { immediate: true }
);
...
const handleDelete = async () => {
    ...
    try {
        const response = await axios.delete(`/delete-messages/${newMessageId.value}`);
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content border-0 rounded-3 shadow">
        ...
        <div class="modal-body text-center">
          <p class="mb-2">Do you really want to delete this Message?</p>
